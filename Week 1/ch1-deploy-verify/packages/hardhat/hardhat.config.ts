...
const config: HardhatUserConfig = {
  ...
  etherscan: {
    apiKey: {
      liskSepolia: process.env.ETHERSCAN_API_KEY || "YOUR_BLOCKSCOUT_API_KEY" // this is or operation so it will still work, cause it will take the ETHERSCAN_API_KEY from .env file
    },
    customChains: [
      {
        network: "liskSepolia",
